...
# def save_to_pickle(data, filename): # """Сохраняет данные в формате Pickle."""
...
#             total_sales = quantity * price_per_unit # Вычислениеобщей выручки
...
# 5
# Конвертация CSV в JSON с изменением структуры данных
